  ...
  return (
    ...
    >
      ...
      <div className="bg-[#213527]/70 rounded-3xl px-5 md:px-10 py-5 md:py-12 max-w-[720px] w-full mx-auto flex flex-col items-center gap-10 z-10 text-center -translate-y-6 fade-in-group" data-stagger-delay="150">
        ...
        {/* Subtext */}
        <p className="fade-in-item text-white/80 text-md md:text-xl font-inter font-normal leading-relaxed max-w-[95%] sm:max-w-[85%]">
        ...
        <Link
          to="/dashboard"
          className="fade-in-item bg-yellow-700 text-white px-6 py-2 text-base md:text-xl rounded-md hover:bg-yellow-800 hover:scale-105 transition duration-300 font-inter"
        >
          Get Started
        </Link>
      </div>
