    ...
    <section className="relative w-full min-h-screen bg-[#213527] text-white px-6 md:px-24 py-24 overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 items-center">
        ...
        <div className="space-y-6 max-w-4xl mx-auto lg:mx-0">
          <h2 className="text-yellow-700 text-[1.1rem] sm:text-md md:text-lg lg:text-lg xl:text-xl font-medium">Why TaskMaster AI?</h2>

          <h3 className="text-[1.65rem] sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold font-josefin leading-tight">
            Smarter Task Management
            <br /> Starts Here
          </h3>

          <p className="text-[1.1rem] sm:text-[1.1rem] md:text-lg lg:text-lg xl:text-xl font-inter text-white/80 max-w-4xl">
          ...
          <div className="space-y-6 pt-4">
            {/* Card 1 */}
            <div
              className="group flex items-center gap-4 md:pl-4 md:pt-4 md:pb-4 sh rounded-xl transition hover:scale-105 hover:bg-[#253d2a] hover:shadow-xl"
            >
            ...
            {/* Card 2 */}
            <div
              className="group flex flex-row-reverse md:flex-row items-center gap-4 pt-2 pb-2 md:pl-4 md:pt-4 md:pb-4 rounded-xl transition hover:scale-105 hover:bg-[#253d2a] hover:shadow-xl"
            >
              <div className="text-yellow-700 text-xl flex items-center justify-center w-11 h-11 md:w-13 md:h-13 p-1 md:p-2 rounded-full bg-white/15">
            ...
            {/* Card 3 */}
            <div
              className="group flex items-center gap-4 md:pl-4
        ...
        <div className="relative bg-gradient-to-b from-[#3d693c] via-[#213527] to-[#213527] rounded-3xl p-6 shadow-2xl flex flex-col justify-between w-full max-w-[345px] md:max-w-[500px] md:min-h-[600px] mx-auto top-5 hover:scale-105 transition-transform duration-300">
          <img
            ...
            className="object-contain w-full max-h-[250px] md:max-h-[375px] mb-6 mt-5 transition duration-800 ease-in-out"
          />
          <div className="mt-auto">
            <div className="bg-yellow-700 text-white/80 px-5 rounded-full text-base sm:text-md md:text-lg lg:text-lg xl:text-xl inline-block mb-2 font-light font-inter">
              NEW
            </div>
            <h4 className="text-xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl font-bold font-josefin text-white/80 mb-1 py-3">AI-Powered Dashboard</h4>
            <p className="text-base sm:text-md md:text-lg lg:text-lg xl:text-xl font-inter text-white/70">
