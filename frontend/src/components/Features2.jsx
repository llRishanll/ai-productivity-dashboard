...
export default function UpcomingFeatures() {
  return (
    <section className="relative w-full bg-[#213527] text-white px-6 md:px-24 py-24 overflow-hidden">
      ...
      {/* Grid Layout */}
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-18 items-center fade-in-group" data-stagger-delay="150">
        
        {/* Left Image */}
        <div className="fade-in-item flex order-2 md:order-1 justify-center lg:justify-start min-h-[380px] md:min-h-[470px] w-full max-w-[345px] md:max-w-[500px] mx-auto pt-12">
          <img
            src={placeholder}
        ...
        {/* Right Content */}
        <div className="order-1 md:order-2 space-y-8 max-w-4xl mx-auto lg:mx-0 fade-in-group" data-stagger-delay="150">
          
          {/* Title */}
          <h2 className="fade-in-item text-[1.65rem] sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold font-josefin leading-tight">
            We're Just Getting Started
          </h2>

          {/* Subtext */}
          <p className="fade-in-item text-[1.1rem] sm:text-[1.1rem] md:text-lg lg:text-lg xl:text-xl font-inter text-white/80 max-w-4xl">
          ...
          <div className="space-y-6 pt-4 fade-in-group" data-stagger-delay="150">
            {/* Item 1 */}
            <div className="fade-in-item group flex items-center gap-4 md:pl-4 md:pt-4 md:pb-4 rounded-xl transition duration-300 hover:scale-105 hover:bg-[#253d2a] hover:shadow-xl">
            ...
            {/* Item 2 */}
            <div className="fade-in-item group flex flex-row-reverse md:flex-row items-center gap-4 pt-2 pb-2 md:pl-4 md:pt-4 md:pb-4 rounded-xl transition duration-300 hover:scale-105 hover:bg-[#253d2a] hover:shadow-xl">
              <div className="text-yellow-700 text-xl flex items-center justify-center w-11 h-11 md:w-13 md:h-13 p-1 md:p-2 rounded-full bg-white/15">
